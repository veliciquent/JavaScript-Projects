...
function Handle_Operator(Next_Operator) {
    ...
    } else if (operator) {// Checks of an operator already exists
        const Value_Now = First_Operand || 0;
        // If operator exists, property lookup is performed for the operator
        // in the Perfomr_Calculation object and the funciton that matches the
...
// This function updates the screen withthe contents of Display_Value
