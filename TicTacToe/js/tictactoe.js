...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // This funciton plays a placement sound
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        // These 3 variables will be used to check ofr 3 in a row
        const a = selectedSquares.includes(squareA)
        const b = selectedSquares.includes(squareB)
        const c = selectedSquares.includes(squareC)
        // If the 3 variables we pass are all included in our array "true" is 
        // returned and our else if conition executes the drawWinLine function
...
// This function takes a sting parameter of the path oyu set earlier for placement sound
function audio(audioURL) {
    // We create a new audio object and we pass the path as a parameter
    let audio = new Audio(audioURL);
    audio.play();
}
// This function utilizes the html cnavas to draw win lines
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    // This line prevents clicking while the win sound is playing
    disableClick();
    //This line plays the win sounds
    audio("./media/winGame.wav");
    // This line calls our main animation loop
    animateLineDrawing();
    // This line waits 1 second then clears the canvas, resets the game, and allows clicking
